    ...
    return (
        <div>
            <div className='w-full h-96 p-10'>
               <div className='my-10'>
               <p className=' style-font text-center'>APPLE ONLY</p>
              ...
              <div  className='flex flex-col items-center gap-3'>
                <img className='w-20 h-20' src={products} alt="" />
